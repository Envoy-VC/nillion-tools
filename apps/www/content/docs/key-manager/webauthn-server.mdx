...
"Registration" is analogous to new account creation. The server will generate the options for the user to create a new credential. It takes in [GenerateRegistrationOptionsOpts](/api-docs/types/webauthn_types.GenerateRegistrationOptionsOpts.html) as props:

<AutoTypeTable path='content/types.ts' name='GenerateRegistrationOptionsOpts' />

It returns [PublicKeyCredentialCreationOptionsJSONWithPRF](/api-docs/types/types.PublicKeyCredentialCreationOptionsJSONWithPRF.html) as the response:
...
After the user has created a new credential, the server will verify the registration response. It takes in [VerifyRegistrationResponseOpts](/api-docs/types/webauthn_types.VerifyRegistrationResponseOpts.html) as props:

<AutoTypeTable path='content/types.ts' name='VerifyRegistrationResponseOpts' />

It returns [VerifiedRegistrationResponse](/api-docs/types/webauthn_types.VerifiedRegistrationResponse.html) as the response:
...
"Authentication" is analogous to logging in. The server will generate the options for the user to authenticate. It takes in [GenerateAuthenticationOptionsOpts](/api-docs/types/webauthn_types.GenerateAuthenticationOptionsOpts.html) as props:
...
It returns [PublicKeyCredentialRequestOptionsJSONWitPRF](/api-docs/types/types.PublicKeyCredentialRequestOptionsJSONWitPRF.html) as the response:
...
After the user has authenticated, the server will verify the authentication response. It takes in [VerifyAuthenticationResponseOpts](/api-docs/types/webauthn_types.VerifyAuthenticationResponseOpts.html) as props:
...
It returns [VerifiedAuthenticationResponse](/api-docs/types/webauthn_types.VerifiedAuthenticationResponse.html) as the response:
